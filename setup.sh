...
function HYPRLAND_DE(){
  ...
  $ZB -S --noconfirm --needed mugshot qt5ct-kde qt6ct-kde sddm-conf-git waybar-module-pacman-updates-git wlogout wttrbar rofi-themes-collection-git hyprshot vdu_controls
  mkdir -p ~/.config/hypr
